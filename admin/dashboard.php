...
if( hasPermissions("adv", "index") ) 
{
    ...
    echo "\t\t\t\t\t\t\t\t\t<div class=\"p-b-10 p-t-5 p-l-15 p-r-0 d-flex justify-content-between cta-box\">\n\t\t\t\t\t\t\t\t\t";
    if( $rAdminSettings["dark_mode"] ) 
    {
    ...
    echo "\t\t\t\t\t\t\t\t\t<div class=\"card-bg bg-secondary1\">\n\t\t\t\t\t\t\t\t\t    <div class=\"p-b-10 p-t-5 p-l-15 p-r-0 d-flex justify-content-between cta-box\">\n\t\t\t\t\t\t\t\t\t\t\t";
    if( $rAdminSettings["dark_mode"] ) 
    {
    ...
    echo "\t\t\t\t\t\t\t\t\t    <div class=\"p-b-10 p-t-5 p-l-15 p-r-0 d-flex justify-content-between\">\n\t\t\t\t\t\t\t\t\t\t\t ";
    if( $rAdminSettings["dark_mode"] ) 
    {
