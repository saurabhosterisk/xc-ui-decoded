            ...
            else
            {
                ...
                if( $_GET["action"] == "stats" ) 
                {
                    ...
                    else
                    {
                        ...
                        $rTotalUsers = $result ? $result->num_rows : 0;
                        ...
                        foreach( ["total_streams", "total_running_streams", "offline_streams", "bytes_received", "bytes_sent"] as $rTotalKey )
                        {
                            $return[$rTotalKey] = 0;
                        }
                        foreach( $return["servers"] as $rServerArray ) 
                        {
                            ...
                            $return["bytes_received"] += $rServerArray["bytes_received"] ?? 0;
                            $return["bytes_sent"] += $rServerArray["bytes_sent"] ?? 0;
                        }
                    }
