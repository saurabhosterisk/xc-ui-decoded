...
if( $rPermissions["is_reseller"] ) 
{
    ...
    echo "                                            </select>\n                                        </div>\n                                        <label class=\"col-md-1 col-form-label text-center\" for=\"stream_show_entries\">";
    echo $_["show"];
...
else
{
    ...
    echo $_["timeshift"];
    echo "</option>\n                                                <option value=\"8\"";
    if( isset($_GET["filter"]) && $_GET["filter"] == 8 ) 
    {
        echo " selected";
    }

    echo ">";
    echo $_["created_channel"];
    echo "</option>\n\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"9\"";
    if( isset($_GET["filter"]) && $_GET["filter"] == 9 ) 
    {
        echo " selected";
    }

    echo ">No Source Channels</option>\n                                            </select>\n                                        </div>\n                                        <label class=\"col-md-1 col-form-label text-center\" for=\"stream_show_entries\">";
    echo $_["show"];
    echo "</label>\n                                        <div class=\"col-md-1\">\n                                            <select id=\"stream_show_entries\" class=\"form-control\" data-toggle=\"select2\">\n                                                ";
    foreach( [10, 25, 50, 250, 500, 1000] as $rShow ) 
    {
...
if( $rPermissions["is_admin"] ) 
{
    echo "                    {\"className\": \"dt-center\", \"targets\": [0,1,4,5,6,7,8,9]},\n                    {\"orderable\": false, \"targets\": [1,6,7]}\n                    ";
}
else
{
    echo "                    {\"className\": \"dt-center\", \"targets\": [0,1,4]}\n                    ";
}
