...
echo "                <!-- start page title -->\n                <div class=\"row\">\n                    <div class=\"col-12\">\n                        <div class=\"page-title-box\">                      \n                            <h4 class=\"page-title\">Mega Iptv</h4>\n                        </div>\n                    </div>\n                </div>     \n                <!-- end page title --> \n                <div class=\"row\">\n                    <div class=\"col-12\">\n                        \n                            <div class=\"card-body\" style=\"overflow-x:auto;\">\t  \n                                <center><iframe src=\"https://mega-iptv-a2636.web.app/\" style=\" background: white; border: none; width: 1060px; height: 750px; align: center\"></iframe></center>\n                            </div> <!-- end card-body -->\n                        \n\n                    </div> <!-- end col -->\n                </div>\n            </div> <!-- end container -->\n        </div>\n        <!-- end wrapper -->\n        ";
if( $rSettings["sidebar"] ) 
{
    echo "</div>";
}
