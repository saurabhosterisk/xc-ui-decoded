...
echo "                <!-- start page title -->\n                <div class=\"row\">\n                    <div class=\"col-12\">\n                        <div class=\"page-title-box\">\n                            <div class=\"page-title-right\">\n                                <ol class=\"breadcrumb m-0\">\n\t\t\t\t\t\t\t\t\t<li>\n                                        <a href=\"./servers.php\">\n\t\t\t\t\t\t\t\t        <button type=\"button\" class=\"btn btn-primary waves-effect waves-light btn-sm\"><i class=\"mdi mdi-keyboard-backspace\"></i> back to Manager Servers</button>\n\t\t\t\t\t\t\t\t\t    </a>\t\n                                    </li>\n                                </ol>\n                            </div>\n                            <h4 class=\"page-title\">IP Server Change </h4>\n                        </div>\n                    </div>\n                </div>     \n                <!-- end page title --> \n                <div class=\"row\">\n                    <div class=\"col-xl-12\">\n                        ";
if( isset($_STATUS) && $_STATUS == 1 ) 
{
    if( !$rSettings["sucessedit"] ) 
    {
        echo "                        <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">\n                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                                <span aria-hidden=\"true\">&times;</span>\n                            </button>\n                            The IP replacement was successful. \n                        </div>\n\t\t\t\t\t\t";
    }
    else
    {
        echo "                    <script type=\"text/javascript\">\n  \t\t\t\t\tswal(\"\", \"The IP replacement was successful.\", \"success\");\n  \t\t\t\t\t</script>\n                        ";
    }

}

echo "                        <div class=\"card\">\n                            <div class=\"card-body\">\n\t\t\t\t\t\t\t\t<div id=\"basicwizard\">\n\t\t\t\t\t\t\t\t\t<ul class=\"nav nav-pills bg-light nav-justified form-wizard-header mb-4\">\n\t\t\t\t\t\t\t\t\t\t<li class=\"nav-item\">\n\t\t\t\t\t\t\t\t\t\t\t<a href=\"#ip-replacement\" data-toggle=\"tab\" class=\"nav-link rounded-0 pt-2 pb-2\"> \n\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"mdi mdi-ip mr-1\"></i>\n\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"d-none d-sm-inline\">IP Change </span>\n\t\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t\t<div class=\"tab-pane\" id=\"ip-replacement\">\n\t\t\t\t\t\t\t\t\t\t\t<form action=\"./ip_change.php\" method=\"POST\" id=\"tools_form\" data-parsley-validate=\"\">\n                                                <div class=\"row\">\n                                                    <div class=\"col-12\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"sub-header\">\n                                                            The IP replacement tool can be used to replace the Main or Balance IP. \n                                                        </p>\n                                                        <div class=\"form-group row mb-4\">\n                                                            <label class=\"col-md-4 col-form-label\" for=\"old_ip\">Old IP </label>\n                                                            <div class=\"col-md-8\">\n                                                                <input type=\"text\" class=\"form-control\" id=\"old_ip\" name=\"old_ip\" value=\"\" placeholder=\"127.0.0.1\" required data-parsley-trigger=\"change\">\n                                                            </div>\n                                                        </div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group row mb-4\">\n                                                            <label class=\"col-md-4 col-form-label\" for=\"new_ip\">New IP </label>\n                                                            <div class=\"col-md-8\">\n                                                                <input type=\"text\" class=\"form-control\" id=\"new_ip\" name=\"new_ip\" value=\"\" placeholder=\"127.0.0.1\" required data-parsley-trigger=\"change\">\n                                                            </div>\n                                                        </div>\n                                                    </div> <!-- end col -->\n                                                </div> <!-- end row -->\n                                                <ul class=\"list-inline wizard mb-0\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"list-inline-item\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"custom-control custom-checkbox\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" class=\"custom-control-input\" id=\"confirmReplace\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label class=\"custom-control-label\" for=\"confirmReplace\">I confirm that I want to replace the old IP with the new IP above. </label>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t</li>\n                                                    <li class=\"list-inline-item float-right\">\n                                                        <input disabled name=\"replace_ip\" id=\"replace_ip\" type=\"submit\" class=\"btn btn-primary\" value=\"Replace IP\" />\n                                                    </li>\n                                                </ul>\n\t\t\t\t\t\t\t\t\t\t\t</form>\n\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div> <!-- end #basicwizard-->\n                            </div> <!-- end card-body -->\n                        </div> <!-- end card-->\n                    </div> <!-- end col -->\n                </div>\n            </div> <!-- end container -->\n        </div>\n        <!-- end wrapper -->\n        ";
if( $rAdminSettings["sidebar"] ) 
{
    echo "</div>";
}
