...
{
    $rStreamProcess = $rStreams[$rProcess["pid"]] ?? NULL;
    echo "                                        <tr>\r\n                                            <td>";
    echo $rProcess["pid"];
    echo "</td>\r\n                                            <td>";
    echo $rProcess["user"];
    echo "</td>\r\n                                            <td>";
    echo ["pid" => $_["main"] . " - ", "monitor_pid" => $_["monitor"] . " - ", "delay_pid" => $_["delayed"] . " - ", "activity" => $_["user_activity"] . " - ", "timeshift" => $_["timeshift"] . " - ", NULL => ""][$rStreamProcess["pid_type"] ?? NULL] . [1 => $_["stream"], 2 => $_["movie"], 3 => $_["created_channel"], 4 => $_["radio"], 5 => $_["episode"], NULL => $_["system"]][$rStreamProcess["type"] ?? NULL];
    echo "</td>\r\n                                            <td>";
    ...
    echo "</td>\r\n                                            <td>";
    echo number_format(floatval($rProcess["rss"]) / 1024, 0);
    echo "</td>\r\n                                            <td>";
    echo $rProcess["time"];
    echo "</td>\r\n                                            <td>\r\n                                                <div class=\"btn-group\">\r\n                                                    ";
    if( isset($rStreams[$rProcess["pid"]]) ) 
