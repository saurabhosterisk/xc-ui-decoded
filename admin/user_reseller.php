...
if( isset($_POST["submit_user"]) ) 
{
    ...
    if( strlen($_POST["username"]) == 0 || $rArray["is_e2"] && !isset($rUser) ) 
    {
    ...
    if( !isset($_STATUS) ) 
    {
        ...
        else
        {
            ...
            if( $db->query($rQuery) ) 
            {
                ...
                header("Location: ./user_reseller.php?successedit&id=" . $rInsertID);
                exit();
            }
            else
            {
            ...
            else
            {
                ...
                else
                {
                    if( $_STATUS == 4 ) 
                    {
                        ...
                        {
                            echo "                    <script type=\"text/javascript\">\n  \t\t\t\t\tswal(\"\", \"You don't have enough credits to complete this purchase!\", \"warning\");\n  \t\t\t\t\t</script>\n                        ";
                        }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if( $_STATUS == 7 ) 
                                {
                                    ...
                                    {
                                        echo "                    <script type=\"text/javascript\">\n  \t\t\t\t\tswal(\"\", \"An invalid MAC address was entered, please try again.\", \"warning\");\n  \t\t\t\t\t</script>\n                        ";
                                    }
...
echo "</th>\n                                                                    </tr>\n                                                                </thead>\n                                                                <tbody></tbody>\n                                                            </table>\n                                                        </div>\n                                                    </div> <!-- end col -->\n                                                </div> <!-- end row -->\n                                                <ul class=\"list-inline wizard mb-0\">\n                                                    <li class=\"previous list-inline-item\">\n                                                        <a href=\"javascript: void(0);\" class=\"btn btn-secondary\">";
echo $_["prev"];
echo "</a>\n                                                    </li>\n                                                    <li class=\"next list-inline-item float-right\">\n                                                        <input name=\"submit_user\" type=\"submit\" class=\"btn btn-primary purchase\" value=\"";
echo $_["purchase"];
echo "\" />\n                                                    </li>\n                                                </ul>\n                                            </div>\n                                        </div> <!-- tab-content -->\n                                    </div> <!-- end #basicwizard-->\n                                </form>\n\n                            </div> <!-- end card-body -->\n                        </div> <!-- end card-->\n                    </div> <!-- end col -->\n                </div>\n            </div> <!-- end container -->\n        </div>\n        <!-- end wrapper -->\n        ";
if( $rSettings["sidebar"] ) 
{
...
if( is_array(json_decode($rUser["bouquet"], true)) ) 
{
    foreach( json_decode($rUser["bouquet"], true) as $rBouquetID ) 
    {
        ...
        if( 0 < strlen($rBouquetID) ) 
        {
            ...
            echo "', ";
            echo count((array) json_decode($rBouquetData["bouquet_channels"], true));
            echo ", ";
            echo count((array) json_decode($rBouquetData["bouquet_series"], true));
            echo "]);\n                 ";
        }
