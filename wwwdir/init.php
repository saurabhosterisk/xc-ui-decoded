...
$db = new ipTV_db($_INFO['db_user'], $_INFO['db_pass'], $_INFO['db_name'], $_INFO['host'], $_INFO['db_port'], empty($_INFO['pconnect']) ? false : true, false);

ipTV_lib::$ipTV_db =& $db;
ipTV_streaming::$ipTV_db =& $db;
ipTV_stream::$ipTV_db =& $db;
ipTV_lib::init();

// Public runtime uses descriptive class names.
